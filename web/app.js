...
(() => {
  ...
  dashIntegrations = async function dashIntegrationsV3() {
    ...
    dashboardShell('connections', headline('CONNECTIONS','MCP connections','Connect remote MCP servers with the authentication they actually require.','<button class="btn primary" id="mcp-add">+ Add connection</button>')+
      ...
      '<section class="mcp-actions"><button id="mcp-add2"><b>Add MCP connection</b><small>URL · transport · authentication</small></button><button id="mcp-curl"><b>Import cURL</b><small>Parse safely; never execute</small></button><button data-mcp-guide="mcp"><b>MCP guide</b><small>All connection modes</small></button><button data-mcp-guide="curl"><b>cURL guide</b><small>Examples + supported input</small></button></section>'+
